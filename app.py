...
cola.markdown(
    f"""<a target="_self" href="https://cinebot.streamlit.app/"><img src="https://raw.githubusercontent.com/erickfm/CineBot/main/images/cinebot1_small.png" style="display:block;" width="100%" height="100%"></a>""",
    unsafe_allow_html=1)
